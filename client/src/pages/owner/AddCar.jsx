    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            ...
            <div className='flex flex-col w-full'>
                <label>Model</label>
                <input type="text" placeholder='e.g. X5, S-Class, M4...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none ' value={car.model} onChange={e=>setCar({...car, model: e.target.value})}/>
            </div>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
            ...
            <div className='flex flex-col w-full'>
                ...
                <input type="number" placeholder='4' required min={2} max={7}  className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.seating_capacity} onChange={e=>setCar({...car, seating_capacity:e.target.value})}/>
                <small className='text-gray-400 text-xs mt-1'>
                    *Allowed range: 2–7 seats
                </small>
            </div>
        </div>
